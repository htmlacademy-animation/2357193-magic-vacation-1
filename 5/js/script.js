...
class FullPageScroll {
  ...
  accentTypographyRun() {
    if(this.screenElements[this.activeScreen].id == 'top') {
      const animationTopScreenTextLine = new _accentTypographyBuild__WEBPACK_IMPORTED_MODULE_1__["default"](`.intro__title`, `text-word--intro`);
        setTimeout(()=>{
          animationTopScreenTextLine.runAnimation();
        }, 500);
        const animationDate = new _accentTypographyBuild__WEBPACK_IMPORTED_MODULE_1__["default"](`.intro__date`, `text-word`);
        setTimeout(()=>{
          animationDate.runAnimation();
        }, 1500);
    }
    else if(this.screenElements[this.activeScreen].id == 'story') {
      const animationTopScreenTextLine = new _accentTypographyBuild__WEBPACK_IMPORTED_MODULE_1__["default"](`.slider__item-title`, `text-word`);
        setTimeout(()=>{
          animationTopScreenTextLine.runAnimation();
        }, 200);
    }
    else if(this.screenElements[this.activeScreen].id == 'prizes') {
      const animationTopScreenTextLine = new _accentTypographyBuild__WEBPACK_IMPORTED_MODULE_1__["default"](`.prizes__title`, `text-word`);
        setTimeout(()=>{
          animationTopScreenTextLine.runAnimation();
        }, 200);
    }
    else if(this.screenElements[this.activeScreen].id == 'rules') {
      const animationTopScreenTextLine = new _accentTypographyBuild__WEBPACK_IMPORTED_MODULE_1__["default"](`.rules__title`, `text-word`);
        setTimeout(()=>{
          animationTopScreenTextLine.runAnimation();
        }, 200);
    }
    else if(this.screenElements[this.activeScreen].id == 'game') {
      const animationTopScreenTextLine = new _accentTypographyBuild__WEBPACK_IMPORTED_MODULE_1__["default"](`.game__title`, `text-word`);
        setTimeout(()=>{
          animationTopScreenTextLine.runAnimation();
        }, 200);
    }
